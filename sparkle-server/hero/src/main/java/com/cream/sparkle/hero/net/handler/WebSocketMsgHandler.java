...
public class WebSocketMsgHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    @Autowired
    public WebSocketMsgHandler(MsgDispatcher msgDispatcher) {
...
//        this.msgDispatcher.dispatch(id, parseMsg);
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
         ...
         */
        if (msgDispatcher.containsChannel(ctx.channel())) {
            this.msgDispatcher.handleDisconnect(ctx.channel(), DisconnectReason.NetDisconnect);
        }
